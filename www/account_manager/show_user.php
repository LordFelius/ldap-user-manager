...
if ($ldap_search) {
 ...
 if (isset($_POST['update_account'])) {
  ...
  if ($updated_account and isset($mail) and $can_send_email == TRUE and isset($_POST['send_email'])) {
      ...
      $mail_body = parse_mail_text($reset_password_mail_body, $password, $account_identifier, $givenname, $sn);
      $mail_subject = parse_mail_text($reset_password_mail_subject, $password, $account_identifier, $givenname, $sn);
