...
foreach ($attribute_map as $attribute => $attr_r) {
    ...
    elseif (!isset($$attribute) && isset($attr_r['default'])) {
...
if (isset($_POST['update_account'])) {
    $mail_attribute = $_POST[$LDAP['search_attribute']];
    ...
    if ($updated_account and isset($mail) and $can_send_email == TRUE and isset($_POST['send_email'])) {
        ...
        $mail_body = parse_mail_text($new_account_mail_body, $password, $mail_attribute, $givenname, $sn);
        $mail_subject = parse_mail_text($new_account_mail_subject, $password, $mail_attribute, $givenname, $sn);
