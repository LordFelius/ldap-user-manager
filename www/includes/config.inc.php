...
$LDAP['account_objectclasses'] = array( 'inetOrgPerson' );
...
#improved
$LDAP['default_request_index'] = array( 'givenname', 'sn', 'mail');
$LDAP['default_initial_index'] = array( 'givenname', 'sn', 'mail', 'uid');
$LDAP['search_attribute'] = (getenv('LDAP_SEARCH_ATTRIBUTE') ? getenv('LDAP_SEARCH_ATTRIBUTE') : 'mail');
if (getenv('LDAP_REQUEST_INDEX')) { $LDAP['set_request_index'] = strtolower(getenv('LDAP_REQUEST_INDEX')); }
if (getenv('LDAP_INITIAL_INDEX')) { $LDAP['set_initial_index'] = strtolower(getenv('LDAP_INITIAL_INDEX')); }
$LDAP['group_class'] = (getenv('LDAP_GROUP_CLASS') ? getenv('LDAP_GROUP_CLASS') : 'groupOfNames');
...
if (getenv('LDAP_ACCOUNT_ADDITIONAL_OBJECTCLASSES')) { $LDAP['account_additional_objectclasses'] = getenv('LDAP_ACCOUNT_ADDITIONAL_OBJECTCLASSES'); }
...
$SITE_NAME = (getenv('SITE_NAME') ? getenv('SITE_NAME') : "$ORGANISATION_NAME 用户门户");
